...
const htmlUrl = "https://cdn.jsdelivr.net/gh/newspaperreports/admin/asLife/index.html";  // 👉 আপডেট: "latest" ট্যাগ সরিয়ে "admin" ফোল্ডার থেকে সরাসরি লোড করছি
...
document.addEventListener("DOMContentLoaded", async () => {
  await loadPopupHTML();        // ⬅️ প্রথমে HTML ইনজেক্ট হচ্ছে
  injectPopupCSS();             // ⬅️ তারপর CSS লোড
  loadNotificationData();       // ⬅️ এরপর ডেটা লোড ও পপআপ শো
...
async function loadNotificationData() {
  try {
    ...
    // 👇 এখানে অবশ্যই HTML লোড হয়ে DOM এ থাকা দরকার, না হলে null আসবে
...
function showNotificationFromJSON(data, encodedIdentifier) {
  const popup = document.getElementById("adminNotification");
  if (!popup) return;  // 👉 এখানে null চেক আছে, safety জন্য
