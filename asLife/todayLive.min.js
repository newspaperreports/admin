...
// 🔐 Base64 encode for identifier generation (for version tracking)
...
// 🗃️ Global variables to track popup state
let currentPopupId = null;

// 🚀 Load on window ready (DOMContentLoaded is safer than full onload)
document.addEventListener("DOMContentLoaded", () => {
  loadNotificationData();

  // ✋ Close button listener (delegated in showNotificationFromJSON)
...
// 📥 Load & process notification JSON data
async function loadNotificationData() {
  try {
    ...
    // 🔄 If popup is already visible, only reload if changed
    ...
    // ❌ If already seen and closed by user, skip
