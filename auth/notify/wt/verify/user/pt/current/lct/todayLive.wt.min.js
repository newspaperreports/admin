...
const htmlUrl = "https://cdn.jsdelivr.net/gh/newspaperreports/admin@main/auth/notify/wt/verify/user/pt/current/lct/index.html?v=2";

// 🔗 CSS File URL (your design file)
const cssUrl = "https://cdn.jsdelivr.net/gh/newspaperreports/admin@main/auth/notify/wt/verify/user/pt/current/lct/todayLive.wt.css?v=2";
