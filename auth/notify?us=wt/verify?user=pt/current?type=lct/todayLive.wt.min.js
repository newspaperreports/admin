...
const jsonUrl = "https://raw.githubusercontent.com/newspaperreports/admin@main/auth/notidy?us=wt/verify?user=pt/current?type=lct/todayLive.wt.json";

// 🔗 HTML Layout URL (popup structure stored in index.html)
const htmlUrl = "https://cdn.jsdelivr.net/gh/newspaperreports/admin/auth/notify?us=wt/verify?user=pt/current?typelct/index.html";

// 🔗 CSS File URL (your design file)
const cssUrl = "https://cdn.jsdelivr.net/gh/newspaperreports/admin/auth/notify?us=wt/verify?user=pt/current?typelct/todayLive.wt.css";
